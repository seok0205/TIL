...
- __검색 기반 생성 기법__, LLM은 많은 데이터를 학습했지만, 최신 정보나 특정 도메인 지식에는 한계를 가질 수 있다. 이를 보완하ㅏ기 위해 RAG는 LLM이 직접 답을 생성하는 대신, 외부 데이터베이스나 문서에서 관련 정보를 검색하여 그 정보를 바탕으로 답변을 생성하는 방식이다.
